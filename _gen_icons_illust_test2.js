...
function buildPrompt(food) {
  return `hyperrealistic digital illustration of only ${food.enName}, floating in empty space, nothing else, no container, no plate, no dish, no bowl, no surface, no shadow beneath, highly detailed, glossy, vibrant colors, pure white background, single object icon, clean edges, centered`;
}

const NEGATIVE = 'plate, white plate, bowl, dish, saucer, tray, table, cutting board, wooden board, surface, ground, shadow, ceramic, garnish, herb sprig, rosemary, parsley, decoration, photograph, photo, group, multiple, text, watermark, cartoon, chibi, face, eyes, character, person, hands';

const FOODS = [
  { id: 'food_meat_chicken',   name: '鸡肉',   enName: 'a piece of raw chicken breast meat', category: 'meat' },
  { id: 'food_veg_broccoli',   name: '西兰花', enName: 'a broccoli floret',                   category: 'vegetable' },
];
