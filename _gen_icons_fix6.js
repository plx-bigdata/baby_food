...
const FOODS = [
  { id: 'food_grain_steamed_bun', name: '馒头',
    prompt: 'Chinese mantou steamed buns on a bamboo steamer, flat vector illustration style, three smooth white round plain mantou buns in a small bamboo steamer, smooth dome shape with no folds no pleats, isolated on pure white background, clean minimal food icon' },
  { id: 'food_meat_pig_liver', name: '猪肝',
    prompt: 'sliced pork liver on a small plate, flat vector illustration style, several thin slices of dark reddish-brown cooked pork liver arranged on a small white plate, isolated on pure white background, clean minimal food icon' },
  { id: 'food_sea_hairtail', name: '带鱼',
    prompt: 'Chinese hairtail belt fish segments on a plate, flat vector illustration style, several cut pieces of silver hairtail fish showing the narrow ribbon-like cross section, on a small plate, isolated on pure white background, clean minimal food icon' },
  { id: 'food_egg_egg_yolk', name: '蛋黄',
    prompt: 'raw egg yolk in a half shell, flat vector illustration style, one bright golden yellow egg yolk sitting in a cracked egg shell half, isolated on pure white background, clean minimal food icon' },
];
